...
-- Create player_ratings table if not exists with correct column names
CREATE TABLE IF NOT EXISTS player_ratings (
    ...
    comment TEXT,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE(rater_player_id, rated_player_id, match_id)
);
...
CREATE INDEX IF NOT EXISTS idx_player_ratings_rater_player_id ON player_ratings(rater_player_id);
